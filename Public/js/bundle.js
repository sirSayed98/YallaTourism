        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.success === true) {
              (0, _alerts.showAlert)('success', 'Welcome 😍', 7);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.success === true) {
              (0, _alerts.showAlert)('success', 'See You Soon... Goodbye 😪');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.success === true) {
              (0, _alerts.showAlert)('success', 'Welcome to YallaTourism 🤗');
              window.setTimeout(function () {
                location.assign('/');
              }, 100);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/auth/updatePassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PUT',
              url: url,
...
var stripe = Stripe('pk_test_51H43g5Gv5F9rU5eRAIaJa6oRce59wd2J9E00X1rtbZX2liv8DOuEmbkpG99p7HVFmPowETGyLluT8jPFewgna9iD00TitMDHJE');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _register.register)(name, email, password, confirmPassword);
  });
}
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            document.querySelector('.btn--save-password').textContent = 'Save password';
            (0, _alerts.showAlert)('error', ' password and confirm don\'t match');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55751" + '/');
