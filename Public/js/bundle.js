      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log(data);
            url = type === 'password' ? 'http://localhost:5000/api/v1/auth/updatePassword' : 'http://localhost:5000/api/v1/users/updateMe';
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PUT',
              url: url,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("\n    http://localhost:5000/api/v1/booking/checkout-session/".concat(tourId));
